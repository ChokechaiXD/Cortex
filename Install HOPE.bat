...
if not exist "%SOURCE_EXE%" (
  echo HOPE executable was not found at:
  echo %SOURCE_EXE%
  echo Build or download HOPE first, then run this installer again.
  pause
  exit /b 1
)
...
:failed
echo.
echo HOPE installation did not finish. No external service was removed.
pause
exit /b 1
